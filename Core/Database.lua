...
NS.DEFAULTS = {
    ...
    interfaceEnhance = {
        ...
        itemLevelPlanner = {
            ...
            fontSize = 13,
            decimalPlaces = 1,
            characterButtonOffsetX = 58,
            characterButtonOffsetY = -34,
            windowShown = false,
            customTargets = {},
            point = nil,
        },
...
function Core:ResetEnhanceQoLIntegrationConfig()
    self.db.interfaceEnhance = self.db.interfaceEnhance or {}
    self.db.interfaceEnhance.enhanceQoLIntegration = CloneTable(NS.DEFAULTS.interfaceEnhance.enhanceQoLIntegration)
    return self.db.interfaceEnhance.enhanceQoLIntegration
end
